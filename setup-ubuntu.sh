...
echo "  2. From your local machine, build and deploy:"
echo "     ./build-remote.sh --push"
echo "  3. Or manually sync files and deploy:"
echo "     rsync -avz ./ vaki-lenovo:~/openclaw/"
echo "     ssh vaki-lenovo 'cd ~/openclaw && ./init-secrets.sh && ./deploy.sh'"
echo ""
